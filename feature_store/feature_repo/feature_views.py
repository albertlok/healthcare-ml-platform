...
patient_appointment_stats = FeatureView(
    ...
    schema=[
        Field(name="no_show_rate_30d", dtype=Float32,
              description="No-show rate over the prior 30 days. Range [0.0, 1.0]."),
        Field(name="no_show_rate_90d", dtype=Float32,
        ...
        Field(name="total_appointments_90d", dtype=Int32,
              description="Total appointment volume over 90 days."),
        Field(name="avg_lead_time_days", dtype=Float32,
              description="Average days between scheduling and appointment start."),
        Field(name="last_appointment_days_ago", dtype=Int32,
...
appointment_context = FeatureView(
    ...
    schema=[
        Field(name="appointment_type_encoded", dtype=Int32,
...
provider_stats = FeatureView(
    ...
    ttl=timedelta(days=90),
    schema=[
        Field(name="provider_no_show_rate_90d", dtype=Float32,
              description="Provider's historical no-show rate over 90 days."),
        Field(name="provider_total_appointments_90d", dtype=Int32,
              description="Provider's total appointment volume over 90 days."),
        Field(name="provider_avg_appointment_duration", dtype=Float32,
